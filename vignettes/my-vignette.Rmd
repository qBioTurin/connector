...
```{r, eval=FALSE}
install.packages(c("cowplot", "fda", "flexclust",
                   "ggplot2", "MASS", "Matrix", "plyr",
                   "ggplotify", "RColorBrewer", "readxl",
                   "reshape2", "splines", "statmod", "sfsmisc",
                   "shinyWidgets", "viridis", "dashboardthemes"))
```
...
```{r, out.width = '70%', fig.align = "center",fig.cap=c("\\label{fig:ConsMatg4} Consensus Matrices for G = 4.")}
