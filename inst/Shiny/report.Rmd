...
# Paramenter selection

```{r , fig.height = 3, fig.width = 7, fig.align = "center"}

if(!is.null(params$infoReport$CrossLL)) params$infoReport$CrossLL
if(!is.null(params$infoReport$PCAplot)) params$infoReport$PCAplot
if(!is.null(params$infoReport$IndexBoxPlot)) params$infoReport$IndexBoxPlot
...
if(!is.null(params$infoReport$ConsMatrix)) params$infoReport$ConsMatrix
